...
import com.example.quotes.ui.theme.screens.MyButtonComponent
import com.example.quotes.ui.theme.screens.MyCard
import com.example.quotes.ui.theme.screens.TextComponent
import com.example.quotes.ui.theme.screens.TextFieldComponent
...
fun UserInputScreen(userInputViewModel: UserInputViewModel,goToScreen: (String)-> Unit) {
    Surface (
        ...
        Column (
            ...
            if (userInputViewModel.isValidState())
                    MyButtonComponent("Goto Welcome Screen",onClickAction = {
                        goToScreen(it)
                })
